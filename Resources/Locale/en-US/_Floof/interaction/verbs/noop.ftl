...
interaction-RudeGesture-description = Pop someone the finger for angering you...
interaction-RudeGesture-success-self-popup = You give the finger to {THE($target)}.
interaction-RudeGesture-success-target-popup = You think that {THE($user)} might have just gave you the finger...
...
interaction-SuggestiveGesture-success-self-popup = You make a circle with your left hand, look at {THE($target)} and star to push your finger through the circle....
